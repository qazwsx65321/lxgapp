...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/EBForeNotification/EBForeNotification/Classes/EBBannerView.xib"
  install_resource "${PODS_ROOT}/EBForeNotification/EBForeNotification/Classes/EBMute.mp3"
