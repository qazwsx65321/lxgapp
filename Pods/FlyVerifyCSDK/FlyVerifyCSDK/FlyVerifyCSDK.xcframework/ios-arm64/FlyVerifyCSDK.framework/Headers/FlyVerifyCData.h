//
//  FlyVerifyCDataUtils.h
//  FlyVerifyCSDK
//
//  Created by flyverify on 24-1-16.
 ...
 *  数据工具类
 */
@interface FlyVerifyCData : NSObject
 ...
 *  @return 校验值
 */
+ (unsigned long)valueByCRC32Data:(NSData *)data;
 ...
 *  @return 检验值
 */
+ (NSString *)stringHexByCRC32Data:(NSData *)data;
