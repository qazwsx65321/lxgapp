...
-(instancetype)initWithFrame:(CGRect)frame andImageArr:(NSArray *)imageArr
{
    ...
    if (self) {
        ...
        [bt_share setBackgroundImage:[UIImage imageNamed:@"share1"] forState:0];
        ...
        [bt_share mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(goodsImgScro.mas_bottom).with.offset(10);
            make.right.mas_equalTo(view).with.offset(-5);
            make.size.mas_equalTo(CGSizeMake(58, 40));
        }];
        ...
        [lb_goodsName mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(goodsImgScro.mas_bottom).with.offset(10);
            make.left.mas_equalTo(view.mas_left).with.offset(10);
            make.right.mas_equalTo(bt_share.mas_left).with.offset(-10);
        ...
        [img_TianMao mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(goodsImgScro.mas_bottom).with.offset(12);
            make.left.mas_equalTo(lb_goodsName);
        ...
        [lb_price mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(lb_goodsName.mas_bottom).with.offset(10);
        ...
        [lb_actitity mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(lb_goodsName.mas_bottom).with.offset(22);
            make.left.mas_equalTo(lb_price.mas_right).with.offset(100);
        ...
        [lb_oldPrice mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(lb_price.mas_bottom).with.offset(10);
            make.left.mas_equalTo(view).with.offset(10);
        ...
        [lb_expressDelivery mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(lb_oldPrice.mas_bottom).with.offset(10);
            make.left.mas_equalTo(view).with.offset(10);
        ...
        [lb_sales mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(lb_oldPrice.mas_bottom).with.offset(10);
        ...
        //店铺
        bt_shop = [[MsButton alloc] initWithFrame:CGRectMake(0, bt_addSize.frame.size.height+bt_addSize.frame.origin.y+10, self.frame.size.width, 100) Head:nil Message:nil];
...
-(void)initdata:(NSDictionary *)dic
{
    ...
    if (isActivity) {
        ...
        [lb_actitity mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.mas_equalTo(lb_price.mas_right).with.offset(10);
        }];
    }
