...
+(NSMutableArray*)IndexArray:(NSArray*)stringArr
{
    ...
    for (NSString* object in tempArray)
    {
        ...
        if (((ChineseString*)object).pinYin.length) {
...
+(NSMutableArray*)LetterSortArray:(NSArray*)stringArr
{
    ...
    for (NSString* object in tempArray) {
        ...
        if (((ChineseString*)object).pinYin.length) {
            ...
            NSData *icon = ((ChineseString *)object).icon?((ChineseString *)object).icon:[NSData data];
            NSString *iconUrl = ((ChineseString *)object).iconUrl?((ChineseString *)object).iconUrl:@"";
            NSString *phone = ((ChineseString *)object).phone?((ChineseString *)object).phone:@"";
            NSString *leixing = ((ChineseString *)object).leixing?((ChineseString *)object).leixing:@"";
            NSString *uid = ((ChineseString *)object).userid?((ChineseString *)object).userid:@"";
...
+(NSMutableArray*)ReturnSortChineseArrar:(NSArray*)stringArr
{
    ...
    for(int i=0;i<[stringArr count];i++)
    {
        ...
        ContactModel *contact = [stringArr objectAtIndex:i];
        chineseString.string= contact.name;
        chineseString.icon = contact.icon;
        chineseString.iconUrl = contact.iconUrl;
        chineseString.phone = contact.phone;
        chineseString.leixing = contact.type;
        chineseString.userid = contact.uid;
