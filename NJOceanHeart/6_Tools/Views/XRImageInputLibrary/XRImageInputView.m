...
#import "XRImageInputView.h"
#import "XRImageInputCell.h"
#import "ZLPhoto.h"
#import "ZLCameraViewController.h"
#import "UIImage+Transcoding.h"

@interface XRImageInputView()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIActionSheetDelegate, ZLPhotoPickerBrowserViewControllerDelegate, ZLPhotoPickerBrowserViewControllerDataSource>
...
@implementation XRImageInputView
...
-(void)openCamera
{
    if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]) {
        ...
        camreaVc.callback = ^(NSArray *assets){
            ...
            [_delegate imageInputViewDidSelectButton:[lbi copy]];
        };
    } else {
