...
// @require
// 数据源/代理
@property (nonatomic , assign) id<ZLPhotoPickerBrowserViewControllerDataSource> dataSource;
@property (nonatomic , assign) id<ZLPhotoPickerBrowserViewControllerDelegate> delegate;
