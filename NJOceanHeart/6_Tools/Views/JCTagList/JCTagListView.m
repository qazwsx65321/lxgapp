...
@property (nonatomic,strong) NSIndexPath *selfIndex;
...
- (void)setup {
    ...
    _selfIndex = [[NSIndexPath alloc] initWithIndex:0];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.canSelectTags) {
        ...
        JCTagCell *cell0 = (JCTagCell *)[collectionView cellForItemAtIndexPath:indexPath];
        JCTagCell *cell1 = (JCTagCell *)[collectionView cellForItemAtIndexPath:_selfIndex];
...
//        }
        ...
        if (self.selfIndex != indexPath) {
            
            cell1.backgroundColor = self.tagBackgroundColor;
            cell1.titleLabel.textColor = self.tagTextColor;
            cell0.backgroundColor = self.tagSelectedBackgroundColor;
            cell0.titleLabel.textColor = self.tagSelectedTextColor;
            _selfIndex = indexPath;
        }
