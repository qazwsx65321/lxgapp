...
- ( NSMutableDictionary *)sendPay_demo
{
    ...
    //    NSString *NOTIFY_URL=@"http://show.xuanrui68.com/XuanR_HappyNine_Server/payNotifyUrl.jsp";
    //================================
    //预付单参数订单设置
    //================================
    ...
    [packageParams setObject: @"127.0.0.2"/*[self getIpAddresses] */   forKey:@"spbill_create_ip"];//发器支付的机器ip
    [packageParams setObject: orderprice       forKey:@"total_fee"];       //订单金额，单位为分
    
    [packageParams setObject: attach       forKey:@"attach"];       //附加数据，在查询API和支付通知中原样返回，该字段主要用于商户携带订单的自定义数据
